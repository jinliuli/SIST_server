...
<body>
	...
	<div id="main">
		...
		<h2 id="titleCalendar">
			<span> <span>활동 내역</span> <span>2024.10</span>
			</span> <span> <span class="material-symbols-outlined" id="btnPrev">skip_previous</span>
				<span class="material-symbols-outlined" id="btnNow">today</span> <span
				class="material-symbols-outlined" id="btnNext">skip_next</span>
			</span>
		</h2>
		...
		function loadCalendar(year, month) {
			...
			$.ajax({
				...
				success: function(result) {
					...
					//{cnt: '2', regdate: '2024-10-15', ccnt: '2', bcnt: '1'}
