...
public class BookDAO {
	...
	public HashMap<String,Object> search(String word, String count, String start) {
        ...
        String apiURL = "https://openapi.naver.com/v1/search/book.json?query=" + text + "&display=" + count + "&start=" + start; // JSON 결과
        ...
        try {
        	...
        	//System.out.println(root.get("total")); //569
        	
        	JSONArray list = (JSONArray)root.get("items");
        	
        	//ArrayList<BookDTO> list 넣어줄꺼 상자만들기
