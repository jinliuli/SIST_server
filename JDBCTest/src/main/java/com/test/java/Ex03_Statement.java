	...
	private static void m1() {
		...
		try {
			...
			if (!conn.isClosed()) {
				...
				//- ORA-00911: invalid character > ';' 문장종결자는 한번만 쓸 수 있음
				String sql = "insert into tblAddress (seq, name, age, gender, tel, address, regdate) values (seqAddress.nextVal, '호랑이', 20, 'm', '010-1234-5678', '서울시 강남구 역삼동', default)";
